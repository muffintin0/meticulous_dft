...
privileged aspect TSFCJobStepDataOnDemand_Roo_DataOnDemand {
    
    declare @type: TSFCJobStepDataOnDemand: @Component;
    
    private Random TSFCJobStepDataOnDemand.rnd = new SecureRandom();
    
    private List<TSFCJobStep> TSFCJobStepDataOnDemand.data;
    
    @Autowired
    TSFCJobDataOnDemand TSFCJobStepDataOnDemand.tSFCJobDataOnDemand;
    
    public TSFCJobStep TSFCJobStepDataOnDemand.getNewTransientTSFCJobStep(int index) {
        TSFCJobStep obj = new TSFCJobStep();
    ...
    public void TSFCJobStepDataOnDemand.setAlphaHOMO(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setAlphaLUMO(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setAlphaOrbital(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setBetaHOMO(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setBetaLUMO(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setBetaOrbital(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setDetailedForce(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setEnergy(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setForce(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setGeometry(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setRelativePath(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setStep(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setUniqueName(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setUnrestrictedSpinGuess(TSFCJobStep obj, int index) {
    ...
    public void TSFCJobStepDataOnDemand.setUnrestrictedSpinReal(TSFCJobStep obj, int index) {
    ...
    public TSFCJobStep TSFCJobStepDataOnDemand.getSpecificTSFCJobStep(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
        ...
        TSFCJobStep obj = data.get(index);
        Long id = obj.getId();
        return TSFCJobStep.findTSFCJobStep(id);
    }
    
    public TSFCJobStep TSFCJobStepDataOnDemand.getRandomTSFCJobStep() {
        init();
        TSFCJobStep obj = data.get(rnd.nextInt(data.size()));
        Long id = obj.getId();
        return TSFCJobStep.findTSFCJobStep(id);
    }
    
    public boolean TSFCJobStepDataOnDemand.modifyTSFCJobStep(TSFCJobStep obj) {
        return false;
    }
    
    public void TSFCJobStepDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = TSFCJobStep.findTSFCJobStepEntries(from, to);
        if (data == null) {
            throw new IllegalStateException("Find entries implementation for 'TSFCJobStep' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<TSFCJobStep>();
        for (int i = 0; i < 10; i++) {
            TSFCJobStep obj = getNewTransientTSFCJobStep(i);
            try {
                obj.persist();
