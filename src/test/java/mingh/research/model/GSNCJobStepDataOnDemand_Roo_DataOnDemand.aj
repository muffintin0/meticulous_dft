...
privileged aspect GSNCJobStepDataOnDemand_Roo_DataOnDemand {
    
    declare @type: GSNCJobStepDataOnDemand: @Component;
    
    private Random GSNCJobStepDataOnDemand.rnd = new SecureRandom();
    
    private List<GSNCJobStep> GSNCJobStepDataOnDemand.data;
    
    @Autowired
    GSNCJobDataOnDemand GSNCJobStepDataOnDemand.gSNCJobDataOnDemand;
    
    public GSNCJobStep GSNCJobStepDataOnDemand.getNewTransientGSNCJobStep(int index) {
        GSNCJobStep obj = new GSNCJobStep();
    ...
    public void GSNCJobStepDataOnDemand.setAlphaHOMO(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setAlphaLUMO(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setAlphaOrbital(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setBetaHOMO(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setBetaLUMO(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setBetaOrbital(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setDetailedForce(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setEnergy(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setForce(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setGeometry(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setRelativePath(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setStep(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setUniqueName(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setUnrestrictedSpinGuess(GSNCJobStep obj, int index) {
    ...
    public void GSNCJobStepDataOnDemand.setUnrestrictedSpinReal(GSNCJobStep obj, int index) {
    ...
    public GSNCJobStep GSNCJobStepDataOnDemand.getSpecificGSNCJobStep(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
        ...
        GSNCJobStep obj = data.get(index);
        Long id = obj.getId();
        return GSNCJobStep.findGSNCJobStep(id);
    }
    
    public GSNCJobStep GSNCJobStepDataOnDemand.getRandomGSNCJobStep() {
        init();
        GSNCJobStep obj = data.get(rnd.nextInt(data.size()));
        Long id = obj.getId();
        return GSNCJobStep.findGSNCJobStep(id);
    }
    
    public boolean GSNCJobStepDataOnDemand.modifyGSNCJobStep(GSNCJobStep obj) {
        return false;
    }
    
    public void GSNCJobStepDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = GSNCJobStep.findGSNCJobStepEntries(from, to);
        if (data == null) {
            throw new IllegalStateException("Find entries implementation for 'GSNCJobStep' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<GSNCJobStep>();
        for (int i = 0; i < 10; i++) {
            GSNCJobStep obj = getNewTransientGSNCJobStep(i);
            try {
                obj.persist();
