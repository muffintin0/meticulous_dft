...
privileged aspect TSNCJobDataOnDemand_Roo_DataOnDemand {
    
    declare @type: TSNCJobDataOnDemand: @Component;
    
    private Random TSNCJobDataOnDemand.rnd = new SecureRandom();
    
    private List<TSNCJob> TSNCJobDataOnDemand.data;
    
    public TSNCJob TSNCJobDataOnDemand.getNewTransientTSNCJob(int index) {
        TSNCJob obj = new TSNCJob();
    ...
    public void TSNCJobDataOnDemand.setAlphaHOMO(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setAlphaLUMO(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setAlphaOrbital(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setBetaHOMO(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setBetaLUMO(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setBetaOrbital(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setCluster(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setDetailedForce(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setEnergy(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setEnthalpy(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setForce(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setGeometry(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setGibbsEnergy(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setInputParams(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setInternalEnergy(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setMolecule(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setRelativePath(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setSiteType(TSNCJob obj, int index) {
        ReactionSiteTypeEnum siteType = ReactionSiteTypeEnum.class.getEnumConstants()[0];
        obj.setSiteType(siteType);
    }
    
    public void TSNCJobDataOnDemand.setSpin(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setStartGeometry(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setUniqueName(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setUnrestrictedSpinGuess(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setUnrestrictedSpinReal(TSNCJob obj, int index) {
    ...
    public void TSNCJobDataOnDemand.setZpe(TSNCJob obj, int index) {
    ...
    public TSNCJob TSNCJobDataOnDemand.getSpecificTSNCJob(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
        ...
        TSNCJob obj = data.get(index);
        Long id = obj.getId();
        return TSNCJob.findTSNCJob(id);
    }
    
    public TSNCJob TSNCJobDataOnDemand.getRandomTSNCJob() {
        init();
        TSNCJob obj = data.get(rnd.nextInt(data.size()));
        Long id = obj.getId();
        return TSNCJob.findTSNCJob(id);
    }
    
    public boolean TSNCJobDataOnDemand.modifyTSNCJob(TSNCJob obj) {
        return false;
    }
    
    public void TSNCJobDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = TSNCJob.findTSNCJobEntries(from, to);
        if (data == null) {
            throw new IllegalStateException("Find entries implementation for 'TSNCJob' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<TSNCJob>();
        for (int i = 0; i < 10; i++) {
            TSNCJob obj = getNewTransientTSNCJob(i);
            try {
                obj.persist();
